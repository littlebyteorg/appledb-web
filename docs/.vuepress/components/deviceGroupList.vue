...
export default {
    ...
    computed: {
        ...
        imageObj() {
            ...
            var ret = {}
            for (const d in firstDeviceObj) ret[d] = `https://img.appledb.dev/device@preview/${firstDeviceObj[d].identifier}/0${this.isDarkMode && firstDeviceObj[d].dark ? '_dark' : ''}.png`
